...
class UserApi
{
     ...
     */
    public function getUserCollection($page = null)
    {
     ...
     */
    public function getUserCollectionWithHttpInfo($page = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCollectionAsync($page = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserCollectionAsyncWithHttpInfo($page = null)
    {
        $returnType = '\ProductApi\Model\UserUserRead[]';
        $request = $this->getUserCollectionRequest($page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserCollectionRequest($page = null)
    {
     ...
     *
     * @param  string $id id (required)
     * @param  \ProductApi\Model\UserUserWrite $user The updated User resource (optional)
     *
     * @throws \ProductApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ProductApi\Model\UserUserRead
     */
    public function patchUserItem($id, $user = null)
    {
        list($response) = $this->patchUserItemWithHttpInfo($id, $user);
        return $response;
    }
     ...
     * @return array of \ProductApi\Model\UserUserRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchUserItemWithHttpInfo($id, $user = null)
    {
        $request = $this->patchUserItemRequest($id, $user);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchUserItemAsync($id, $user = null)
    {
        return $this->patchUserItemAsyncWithHttpInfo($id, $user)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchUserItemAsyncWithHttpInfo($id, $user = null)
    {
        $returnType = '\ProductApi\Model\UserUserRead';
        $request = $this->patchUserItemRequest($id, $user);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchUserItemRequest($id, $user = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \ProductApi\Model\UserUserWrite $user The new User resource (optional)
     *
     * @throws \ProductApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ProductApi\Model\UserUserRead
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postUserCollectionRequest($user = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putUserItemRequest($id, $user = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
