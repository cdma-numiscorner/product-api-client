...
/**
 * CategoriesRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  ProductApi
 ...
 */
class CategoriesRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Categories-Read';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'slug' => 'string',
        'parent_category' => '\ProductApi\Model\CategoriesRead'
    ];
     ...
     *
     * @param \ProductApi\Model\CategoriesRead|null $parent_category parent_category
     *
     * @return self
     */
